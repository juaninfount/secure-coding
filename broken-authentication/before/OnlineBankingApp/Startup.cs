...
using OnlineBankingApp.Identity;
...
namespace OnlineBankingApp
{
    public class Startup
    {
        ...
        {
            /* 
            Not requiring lowercase, alphanumeric, and uppercase characters is no longer an 
            acceptable password policy
            */
            ...
            // web application must keep the length of an authenticated user's session to a minimum
            ...
            services.AddSingleton<IPasswordHasher<Customer>, PasswordHasher>();
